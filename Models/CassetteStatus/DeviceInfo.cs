...
namespace SLA_Management.Models.CassetteStatus
{
    ...
    public class DeviceInfo
    {
        ...
        public string TERM_ZONE { get; set; }
        ...
        public string FLAG_XFS { get; set; }
        public string FLAG_EJ { get; set; }
        public string FLAG_FSN { get; set; }
        ...
        public DateTime? ATMC_UPDATE_TIME { get; set; }
        public DateTime? SP_UPDATE_TIME { get; set; }
        public DateTime? AGENT_UPDATE_TIME { get; set; }
        public string VERSION_NV { get; set; }
        public DateTime? NV_UPDATE_TIME { get; set; }
        public string VERSION_MAIN { get; set; }
        public DateTime? MAIN_UPDATE_TIME { get; set; }
    }
}
