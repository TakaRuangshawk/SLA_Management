  ...
  END AS Status,
      ...
      , string currPageSize, int? page, string maxRows, string terminalType, string startDate, string bankName)
        ...
        public IActionResult EJLogAnalyst(string bankName, string terminalId, string transactionStatus, string FrDate, string ToDate, string lstPageSize, string currPageSize, int? page, string maxRows)
        {
            ...
            dBService = new DBService_EJLoganalyst(_myConfiguration, _myConfiguration.GetValue<string>("ConnectString_NonOutsource:FullNameConnection_baac"));
            ...
            try
            {
                ...
                LatestUpdated_record latestUpdate = dBService.GetLatestUpdate();
