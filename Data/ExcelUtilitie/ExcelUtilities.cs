            ...
            try
            {
                ...
                using (var oPackage = new ExcelPackage(oTemplate))
                {
                    ...
                    foreach (InventoryMaintenanceModel data in objData)
                    {
                        ...
                        excelWorksheet.Cells[nStartRowData, 6].Value = data.UPS;
                        excelWorksheet.Cells[nStartRowData, 7].Value = data.Connected;
                        excelWorksheet.Cells[nStartRowData, 8].Value = data.Status;
                        excelWorksheet.Cells[nStartRowData, 9].Value = data.COUNTER_CODE;
                        excelWorksheet.Cells[nStartRowData, 10].Value = data.ServiceType;
                        excelWorksheet.Cells[nStartRowData, 11].Value = data.TERM_LOCATION;
                        excelWorksheet.Cells[nStartRowData, 12].Value = data.LATITUDE;
                        excelWorksheet.Cells[nStartRowData, 13].Value = data.LONGITUDE;
                        excelWorksheet.Cells[nStartRowData, 14].Value = data.CONTROL_BY;
                        excelWorksheet.Cells[nStartRowData, 15].Value = data.PROVINCE;
                        excelWorksheet.Cells[nStartRowData, 16].Value = data.SERVICE_BEGINDATE;
                        excelWorksheet.Cells[nStartRowData, 17].Value = data.SERVICE_ENDDATE;
                        excelWorksheet.Cells[nStartRowData, 18].Value = data.VERSION_MASTER;
                        excelWorksheet.Cells[nStartRowData, 19].Value = data.VERSION;
                        excelWorksheet.Cells[nStartRowData, 20].Value = data.VERSION_AGENT;
                        nStartRowData++;
                        nSeq++;
